...
<template>
  <nav aria-label="Progress" class="my-11 mx-11">
...
const steps = [
  { name: 'Step 1', href: '#',descraption:"حقيبة التسوق", status: 'complete' },
  { name: 'Step 2', href: '#',descraption:"تأكيد الطلب", status: 'current' },
  { name: 'Step 3', href: '#',descraption:"دفع", status: 'upcoming' },
  { name: 'Step 4', href: '#',descraption:"تم الطلب", status: 'upcoming' },
]
