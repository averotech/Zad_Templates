...
<template>
  <nav class="  bg-[#201A3C]  text-white space-y-3" aria-label="Sidebar">
    <a href="" class="  grid grid-cols-1 p-3 gap-4 place-items-end border-b-2 border-[#393063]">

       الملف الشخصي
    </a>

    <a 
    class="flex justify-between flex-row-reverse px-3 py-2 text-sm font-shamelnormal rounded-md border-b-2  border-[#393063]"
    v-for="item in navigation" :key="item.name" :href="item.href"  :aria-current="item.current ? 'page' : undefined">
      <span class="truncate hover:text-gold">
        {{ item.name }}
      </span>
      <svg width="11" height="17" viewBox="0 0 11 17" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.1582 16.1799L10.1582 0.820002C10.1582 0.0931492 9.28049 -0.277135 8.75934 0.244005L1.07932 7.92396C0.763893 8.23939 0.763893 8.76053 1.07932 9.07609L8.75934 16.7561C9.28049 17.2771 10.1582 16.9068 10.1582 16.1799Z" fill="white"/>
</svg>

    </a>

     <a href=""     class="flex justify-between flex-row-reverse px-3 py-2 text-sm font-medium rounded-md "

>
<span class="  hover:text-gold
">
  تسيجل خروج
